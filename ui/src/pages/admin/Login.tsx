  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden pointer-events-none opacity-40">
        ...
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-purple-200 rounded-full blur-[100px]"></div>
      </div>
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="glass p-8 md:p-10 rounded-3xl shadow-xl border border-white/50 bg-white/80">
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="text-3xl font-bold text-slate-900 mb-2 tracking-tight">Admin Portal</h1>
            <p className="text-slate-500">Sign in to manage the Smart Campus system.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700 ml-1">Admin Username</label>
