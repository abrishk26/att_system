      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="p-8 md:p-10 rounded-3xl shadow-2xl border border-slate-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 transition-colors duration-300">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <p className="text-slate-500 dark:text-neutral-400 text-sm">Sign in to access your dashboard and attendance.</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="flex items-center text-sm">
              <label className="flex items-center text-slate-600 dark:text-neutral-400 cursor-pointer gap-2">
                <input type="checkbox" className="rounded border-slate-300 dark:border-neutral-600 text-indigo-500 focus:ring-indigo-500 bg-white dark:bg-neutral-800" />
                Remember me
              </label>
            </div>
