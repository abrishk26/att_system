                        ...
                        <Link to="/" className="flex items-center gap-3">
                            ...
                            {!isCollapsed && (
                                <div className="transition-opacity duration-300 opacity-100 whitespace-nowrap">
                                    ...
                                    <span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest text-primary">Student Portal</span>
                                </div>
                            )}
                        </Link>
                        {!isCollapsed && (
                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="hidden sm:block text-right">
                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight leading-none mb-1">Student</p>
                                    ...
                                    <div className="absolute right-0 mt-3 w-72 bg-white rounded-2xl shadow-2xl border border-slate-100 py-2 z-20 animate-in fade-in zoom-in-95 duration-200 origin-top-right overflow-hidden">
                                        <div className="px-5 py-4 border-b border-slate-50 bg-slate-50/30">
                                            <div className="flex items-center gap-3 mb-4">
                                                ...
                                                <div className="min-w-0">
                                                    <p className="text-base font-bold text-slate-900 truncate">{studentName}</p>
                                            ...
                                            <div className="flex items-center justify-between p-3 rounded-xl bg-white border border-slate-200 shadow-sm">
                                                <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">NFC ID</span>
                                        ...
                                        <div className="p-2">
                                            <button
                                                ...
                                                className="w-full flex items-center gap-3 px-4 py-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all font-bold text-sm"
                                            >
